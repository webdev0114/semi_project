...
<form action="<%=request.getContextPath() %>/F_Delete.f" method="post" >
...
<input type="hidden" name="page" value="${param.page  }">
	...
	<div class="mb-3">
			<input type="password" class="form-control" id="f_pw" name="f_pw" size="10" maxlength="10" placeholder="비밀번호">
		</div>
