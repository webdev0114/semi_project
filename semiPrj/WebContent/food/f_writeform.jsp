...
<body>
	...
	<div class="container">
		<form class="form-signin" action="<%=request.getContextPath() %>/F_AddAction.f" method="post" 
			  enctype="multipart/form-data">
			<input type="hidden" name="id" value="${sessionScope.id }">

			<div class="text-left">
				<h2 class="section-title"> 맛집 글쓰기</h2>
			</div>
			...
			<div class="mb-3">
			      <input class="form-control" type="text" name="f_name" id="f_name" placeholder="식당 이름"> 
			   </div>
			
			<div class="mb-3">
			     <input type="password" name="f_pw" class="form-control" name="f_pw" id="f_pw" placeholder="비밀번호">
			   </div>
			
			<div class="mb-3">
			       <textarea class="form-control" name="f_content" id="f_content" rows="10" placeholder="식당 소개"></textarea>
			   </div>
			   
			<div class="mb-3">
			      <input class="form-control" type="text" name="f_addr" id="f_addr" placeholder="식당 주소"> 
			   </div>
			   
			<div class="mb-3">
			      <input class="form-control" type="file" name="f_file" id="f_file" placeholder="사진"> 
			   </div>
			   
				<hr class="mb-4">
			<div class="text-left">
			       <button type=submit class="btn btn-light btn-sm">등록</button>
