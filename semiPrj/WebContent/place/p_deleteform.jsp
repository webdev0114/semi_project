...
<form action="<%=request.getContextPath() %>/P_Delete.p" method="post">
<input type="hidden" name="p_num" value="${param.p_num}">
<input type="hidden" name="page" value="${param.page}">
	<h6>삭제하시겠습니까?</h6>
		<div class="mb-3">
			<input type="password" class="form-control" id="p_pw" name="p_pw" size="10" maxlength="10" placeholder="비밀번호">
		</div>
