...
<form action="<%=request.getContextPath() %>/Q_Delete.q" method="post">
	<input type="hidden" name="q_num" value="${param.q_num}">
	<input type="hidden" name="page" value="${param.page}">
	
		<div class="mb-3">
			<input type="password" class="form-control" id="q_pw" name="q_pw" size="10" maxlength="10" placeholder="비밀번호">
		</div>
