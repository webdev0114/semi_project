...
<body class="text-center">
	<div class="container">
		<div class="row gutter-v1 align-items-stretch mb-5">
			<div class="col-12">
				<form class="form-signin" action="<%=request.getContextPath()%>/Q_Modify.q" method="post">
				<input type="hidden" name="q_num" value="${board.q_num}">
				<input type="hidden" name="page" value="${page}">

		 			<div class="text-left">
			          	<h2 class="section-title">Q&A 수정</h2>
		          	</div>
		          	
			  		 <div class="mb-3">
			   			<input type="text" class="form-control" id="id" 
			   				placeholder="${board.id}" readonly>
			  		 </div>
			
					 <div class="mb-3">
			      		<input type="password" name="q_pw" class="form-control" 
			      			id="q_pw" placeholder="비밀번호">
			    	 </div>
				
					<div class="mb-3">
			       		<input class="form-control" type="text" name="q_title" id="q_title" 
			       			value="${board.q_title}"> 
			    	</div>
					
					<div class="mb-3">
			        	<textarea class="form-control" name="q_content" id="q_content" 
							rows="10">${board.q_content}</textarea>
			    	</div>
