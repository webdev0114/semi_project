...
<body style="background-color: #f8f8f8">
	...
	<div class="container">
		<div class="row gutter-v1 align-items-stretch mb-5">
			<div class="col-12">
				<form class="form-signin" action="<%=request.getContextPath()%>/Q_Reply.q" method="post">
				<input type="hidden" name="q_num" value="${board.q_num}">
				<input type="hidden" name="q_ref" value="${board.q_ref}">
				<input type="hidden" name="q_step" value="${board.q_step}">
				<input type="hidden" name="q_lvl" value="${board.q_lvl}">
				<input type="hidden" name="page" value="${page}">
				<input type="hidden" name="id" value="${sessionScope.id }">

					<div class="text-left">
			          	<h2 class="section-title">Q&A 답변</h2>
		          	</div>
					...
					<div class="mb-3">
						<input class="form-control" type="text" name="q_title"
							id="q_title" placeholder="제목">
					</div>

					<div class="mb-3">
						<input type="password" name="q_pw" class="form-control" name="q_pw "id="q_pw"
							placeholder="비밀번호">
					</div>
					
					<div class="mb-3">
						<textarea class="form-control" name="q_content" id="q_content" rows="10"
					...
					<div class="text-left">
						...
						<button type=button class="btn btn-light btn-sm" 
							onClick="location.href='./Q_ListAction.q?page=${page}'">목록</button>
					</div>
				</form>
			</div>
		</div>
