...
<body class="text-center">
	<div class="container">
		<div class="row gutter-v1 align-items-stretch mb-5">
			<div class="col-12">
				<form class="form-signin" action="<%=request.getContextPath() %>/R_Modify.r" method="post"
				...
				<input type="hidden" name="page" value="${page }">
					...
					<div class="text-left">
		          	...
		          	<div class="mb-3">
			   			<input type="text" class="form-control" id="id" 
			   				placeholder="${review.id}" readonly>
			  		 </div>
			  		 
			  		 <div class="mb-3">
			      		<input type="password" name="r_pw" class="form-control" 
			      			id="r_pw" placeholder="비밀번호">
			    	 </div>
			    	...
			    	<div class="mb-3">
			        	<textarea class="form-control" name="r_content" id="r_content" 
							rows="10">${review.r_content}</textarea>
			    	</div>
